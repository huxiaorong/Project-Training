package com.chinese.wyy.controller;
...
import com.chinese.wyy.dao.ChineseDao;
...
public class ChineseController {
	...
	@RequestMapping("/han")
	public void hanzishiyin(HttpServletRequest request, HttpServletResponse response,ModelMap model) throws IOException {
		response.setContentType("text/html; charset=utf-8");
		request.setCharacterEncoding("utf-8");
		response.setCharacterEncoding("utf-8");
		...
		int id = Integer.parseInt(userId);
		List<Integer> list = chineseDao.selectWrongWord(id);
		List<Question_hanzishiyin> qlist = chineseDao.questionHan(list);
	...
	public void updateCount(HttpServletRequest request, HttpServletResponse response,ModelMap model) throws IOException {
		response.setContentType("text/html; charset=utf-8");
		request.setCharacterEncoding("utf-8");
		response.setCharacterEncoding("utf-8");
		...
		System.out.println(count+"wwww1234567");
		chineseDao.updateCount(count, id);
		

	}
	
	@RequestMapping("/getCount")
	public void getCount(HttpServletRequest request, HttpServletResponse response,ModelMap model) throws IOException {
		response.setContentType("text/html; charset=utf-8");
		request.setCharacterEncoding("utf-8");
		response.setCharacterEncoding("utf-8");
		...
		int count = chineseDao.getTodaysCount(id);

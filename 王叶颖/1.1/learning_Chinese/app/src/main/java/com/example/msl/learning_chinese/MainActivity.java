...
import com.example.msl.learning_chinese.CenterFragment;
import com.example.msl.learning_chinese.GamesFragment;
import com.example.msl.learning_chinese.RefresherFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (intent.getStringExtra("type")!=null && intent.getStringExtra("type").equals("fuxi")){
    ...
    private void setFragment() {
        ...
        map.get(tabStrId[1]).setFragment(new ReviewFragment());
    ...
    private void findView() {
        ...
        TextView tv1 = findViewById(R.id.tv_homepage);
        TextView tv2 = findViewById(R.id.tv_fuxi);
        TextView tv3 = findViewById(R.id.tv_quxue);

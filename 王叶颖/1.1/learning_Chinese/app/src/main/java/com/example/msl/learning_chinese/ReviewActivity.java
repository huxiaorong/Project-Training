...
public class ReviewActivity extends AppCompatActivity {
            ...
            switch (msg.what) {
                case 1:
                    try {
                        ...
                        reviewedNum.setText(String.valueOf(Constant.USER_STATUS.getTodayCount()));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //llyuan = findViewById(R.id.ll_yuan);

        reviewedNum = (TextView)findViewById(R.id.tv_reviewed);
        goalNum = (TextView) findViewById(R.id.tv_goal);
...
//                reviewedNum.setText(String.valueOf(Constant.USER_STATUS.getTodayCount()));
//                goalNum.setText("50");
//                Log.e("1111",reviewedNum.getText()+"");
//                Log.e("1111",goalNum.getText()+"");
//            }
//        }.start();
        ...
        xuancitiankong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent();
                i.setClass(ReviewActivity.this,TiActivity.class);
                startActivity(i);
            }
        });
    }

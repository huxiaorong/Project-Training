...
//                }
        ...
        btnKnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Constant.USER_STATUS.setNumberTag(Constant.USER_STATUS.getNumberTag() + 1);
                updateNumProgress();
                if (Constant.USER_STATUS.getNumberTag() < wordList.size()) {
        ...
        btnDetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(WordDetailsActivity.this,BaiduDetailsActivity.class);
    ...
    private void initDate() {
        ...
        tvExplanation.setText(cutStr(word.getExplanation(),160));
        if (null!=word.getSentence1()){
            tvSentence1.setMyText(word.getSentence1());
        }
        if (null!=word.getSentence2()){
            tvSentence2.setMyText(word.getSentence2());
        }
        if (null!=word.getSentence3()){
...
//        }
    ...
    */
    private void updateNumProgress() {
        ...
        Request request = new Request.Builder()
                .url(Constant.BASE_URL + "user/update/num?userId=" + Constant.USER_STATUS.getId())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
    ...
    */
    private void recordTime() {
        ...
        //2.创建Request对象
        Request request = new Request.Builder()
                .url(Constant.BASE_URL + "record/add?userId=" + Constant.USER_STATUS.getId())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求
    ...
    */
    private void addWrongWord() {
        ...
        //2.创建Request对象
        Request request = new Request.Builder()
                .url(Constant.BASE_URL + "word/add/wrong?userId=" + Constant.USER_STATUS.getId() + "&wordId=" + word.getId())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求
    ...
    */
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String url) {
            webView.loadUrl("javascript:hwanimate(" + "'"+word.getWord()+"'" + ")");
        }
    }
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
            Toast.makeText(WordDetailsActivity.this, message, Toast.LENGTH_SHORT).show();
            return true;
        }
    }

...
public class Word {
    ...
    public Word(int id, String word, String explanation, String sentence1,
                String sentence2, String sentence3, int tag) {
        super();
        this.id = id;
        this.word = word;
    ...
    public Word(int id, String word, String explanation, String sentence1, String sentence2, String sentence3, int tag, int findlevel, String likeword) {
        this.id = id;
        this.word = word;
        this.explanation = explanation;
        this.sentence1 = sentence1;

...
//        if (w == 0) w = 7;
    ...
    */
    private void getWordList() {
        ...
        Request request = new Request.Builder()
                .url(BASE_URL + "word/list?pageNum=" + pageNum + "&tag=" + Constant.USER_STATUS.getLevelTag())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
    ...
    */
    private void findToday() {
        ...
        final Request request = new Request.Builder()
                .url(BASE_URL + "record/find/today?userId=" + Constant.USER_STATUS.getId())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求
    ...
    */
    private void updateProgress() {
        ...
        //2.创建Request对象
        Request request = new Request.Builder()
                .url(BASE_URL + "user/update/progress?userId=" + Constant.USER_STATUS.getId() + "&studiedTag=" + pageNum + "&numberTag=" + wordNum)//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求
    ...
    private void getBooksList() {
        ...
        //2.创建Request对象
        Request request = new Request.Builder()
                .url(BASE_URL + "level/list")//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求
    ...
    */
    private void findThisWeek() {
        ...
        //2.创建Request对象
        final Request request = new Request.Builder()
                .url(BASE_URL + "record/find/thisWeek?userId=" + Constant.USER_STATUS.getId())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求
    ...
    */
    private void getNumByTag() {
        ...
        //2.创建Request对象
        Request request = new Request.Builder()
                .url(BASE_URL + "word/count/tag?tag=" + Constant.USER_STATUS.getLevelTag())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求
    ...
    */
    private void getLearnedWordList() {
        ...
        //2.创建Request对象
        Request request = new Request.Builder()
                .url(BASE_URL + "word/find/learned?userId=" + Constant.USER_STATUS.getId())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求
    ...
    */
    private void getNotLearnedWordList() {
        ...
        //2.创建Request对象
        Request request = new Request.Builder()
                .url(BASE_URL + "word/find/notLearned?userId=" + Constant.USER_STATUS.getId())//设置网络请求的URL地址
                .build();
        //3.创建Call对象
        Call call = okHttpClient.newCall(request);
        //4.发送请求

...
import cn.edu.hebtu.software.learning_chinese.entity.Question;
...
public class TingyinxuanziActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivReturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent();
                i.setClass(TingyinxuanziActivity.this, ReviewActivity.class);
                startActivity(i);
            }
        });
    ...
    public void reviewed(){
        Request requestBlog = new Request.Builder()
                .url(Constant.BASE_URL + "tingyinshizi?userId="+Constant.userId)
                .build();
        try {

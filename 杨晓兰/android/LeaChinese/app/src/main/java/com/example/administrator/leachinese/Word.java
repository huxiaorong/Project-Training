...
public class Word {
    ...
    public Word(int id, String word, String pinyin, String audio, String explanation, String sentence1, String pinyin1, String sentence2, String pinyin2, String sentence3, String pinyin3, int tag) {
        this.id = id;
        this.word = word;
        this.pinyin = pinyin;
        this.audio = audio;

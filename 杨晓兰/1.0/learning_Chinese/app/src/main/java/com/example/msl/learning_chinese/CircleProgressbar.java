...
public class CircleProgressbar extends android.support.v7.widget.AppCompatTextView {
   ...
   /* @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        if (typedArray.hasValue(R.styleable.CircleProgressBar_progress_text_color))
            inCircleColors = typedArray.getColorStateList(R.styleable.CircleProgressBar_progress_text_color);
        else

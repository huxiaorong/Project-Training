...
public class User {
    ...
    public User(int id, String userName, String password, String tel, String sex, int studiedTag, int numberTag, int levelTag, String img, int levelone, int leveltwo, int levelthree) {
        this.id = id;
        this.userName = userName;
        this.password = password;
        this.tel = tel;

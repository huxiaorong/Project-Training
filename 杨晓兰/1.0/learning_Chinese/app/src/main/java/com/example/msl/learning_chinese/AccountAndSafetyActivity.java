...
public class AccountAndSafetyActivity extends AppCompatActivity {
            ...
            switch (msg.what) {
                ...
                case 2:
                    if (rsp.equals("注销成功")){
                        ...
                        Intent intent = new Intent(AccountAndSafetyActivity.this, PersonalCenterActivity.class);
                        startActivity(intent);
                    }
                    break;
                    ...
                    new AlertDialog.Builder(AccountAndSafetyActivity.this)
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    cancellation();
                                    Intent intent3 = new Intent(AccountAndSafetyActivity.this, PersonalCenterActivity.class);
                                    Constant.USER_STATUS = null;
    ...
    private void cancellation() {
        ...
        FormBody body = new FormBody.Builder()
                .add("userId", Constant.USER_STATUS.getId()+"")
                .build();

package com.chinese.weixinxin.util;
...
public abstract class BaseDaow<T,PK extends Serializable> {
    ...
    public T load(Serializable id) throws Exception {
		return this.sessionFactory.getCurrentSession().load(entityClass, id);
	}

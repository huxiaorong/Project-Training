...
public class UserServiceImpl {
	...
	public void addUserProgress(UserProgress userProgress) {
		this.userProgressDaoImpl.saveUserProgress(userProgress);
	}
	
	public Collection judgeCollect(int userId,int wordId){
		return this.collectionDaoImpl.selectCollectOrNot(userId, wordId);
	}
	
	public void deleteCollection(int userId,int wordId){
		this.collectionDaoImpl.delectCollect(userId,wordId);
	}
